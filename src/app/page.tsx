...
export default function HomePage() {
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 leading-tight text-white drop-shadow-lg">
              Sua beleza em dia,
              <br />
              <span className="text-gold drop-shadow-md">sem surpresas no bolso</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/#planos"
                className="px-8 py-4 bg-gold text-purple-text font-semibold rounded-lg hover:shadow-gold hover:scale-105 transition-all duration-200 flex items-center gap-2 min-w-[200px] justify-center"
              >
                Ver Planos
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-heading font-bold text-purple-text mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center p-8 rounded-2xl bg-purple-lighter/20 hover:bg-purple-lighter/30 transition-all duration-200 hover:shadow-md">
              <div className="w-16 h-16 bg-gradient-purple rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Clock className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-heading font-bold text-purple-text mb-3">
                Praticidade Total
              </h3>
      ...
      {/* Plans Section */}
      <section id="planos" className="py-20 px-4 bg-gradient-to-b from-purple-lighter/10 to-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-purple-text mb-4">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {customerReviews.slice(0, 3).map((review) => (
              <div
                key={review.id}
                className="bg-white border-2 border-purple-lighter/40 rounded-xl p-6 hover:border-purple/50 hover:shadow-lg transition-all duration-200"
              >
          ...
          <div className="text-center mt-8">
            <Link
              href="/avaliacoes"
              className="inline-flex items-center gap-2 text-purple hover:text-purple-medium transition-colors font-semibold"
            >
      ...
      <section className="py-20 px-4 bg-gradient-purple text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6 drop-shadow-lg">
          ...
          <Link
            href="/#planos"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gold text-purple-text font-semibold rounded-lg hover:shadow-gold hover:scale-105 transition-all duration-200"
          >
            Começar Agora
            <ArrowRight className="w-5 h-5" />
          </Link>
